        ...
        <header className="header">
            <div className="header__container">
                ...
                <nav className="header__nav">
                    ...
                    <a href="/new-arrivals" className="header__nav-link">HÀNG MỚI VỀ</a>
                    <a href="/collections" className="header__nav-link">BỘ SƯU TẬP</a>
                ...
                <div className="header__actions">
                    ...
                    <button className="header__icon-btn header__cart" aria-label="Shopping Cart">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path d="M2.5 2.5H3.5L5.5 13.5H16.5L18.5 6.5H4.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
