            ...
            <div className="account-page__content">
                <div className="account-form">
                    ...
                    <div className="account-form__header">
                        ...
                        <div>
                            <h1 className="account-form__title">Tạo tài khoản mới</h1>
                    ...
                    <form className="account-form__body" onSubmit={handleSubmit}>
                        ...
                        <div className="account-form__section">
                            <h3 className="account-form__section-title">Bảo mật</h3>
                            <div className="account-form__grid">
                                <div className="account-form__field">
                                    <label className="account-form__label">
                                        Mật khẩu <span className="account-form__required">*</span>
                                    </label>
                                ...
                                <div className="account-form__field">
                                    <label className="account-form__label">
                                        Xác nhận mật khẩu <span className="account-form__required">*</span>
                                    </label>
                                    <div className="account-form__input-wrapper">
                                        <input
